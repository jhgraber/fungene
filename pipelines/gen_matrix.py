...
def prog_usage():
    usage='''
       ...
       ***************************************************************************************
       ...
       Usage: PROG [-h] --infiles=files --outdir=path2/output_prefix --jindex=indexOfColumnValues [--vindex=indexOfRowIDs] [--round]
       Where:
           -h To show the usage
           ...
           -o path2/output_prefix Or  --outdir=path2/output_prefix ... required, 
...
if __name__== "__main__":
    ...
    if input_files is None or _jindex is None:
        prog_usage()
        sys.exit()
